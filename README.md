...
![Imaginea creata cu succes](assets/image.png)

**2. Containerul ruland**

![Containerul Docker ruland](assets/image-1.png)

**3. Accesarea aplicatiei din browser**
![Accesare ruta generala](assets/image-2.png)
![Accesare ruta element](assets/image-3.png)
![Accesare lista de elemente](assets/image-4.png)
![Accesare detalii element](assets/image-5.png)

**4. Log-urile din consola care confirma accesarea**
![Log-uri consola](assets/image-6.png)

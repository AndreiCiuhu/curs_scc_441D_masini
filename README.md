...
![Teste unitare Porsche](docs/poze_readme/teste_unitare.png)
...
![Pagina Porsche](docs/poze_readme/pagina_porsche.png)

### Pagina Modele Porsche

![Pagina Modele Porsche](docs/poze_readme/pagina_modele_porsche.png)

### Pagina Istoria Porsche 911

![Pagina Istoria Porsche 911](docs/poze_readme/pagina_istorie_911.png)
...
![Docker build start](docs/poze_readme/docker_build_start.png)

### Imagine Docker construită cu succes

![Docker build success](docs/poze_readme/docker_build_success.png)
...
![Imagine Docker](docs/poze_readme/docker_images.png)
...
![Jenkins SUCCESS](docs/poze_readme/jenkins_success.png)

### Pipeline Jenkins

![Jenkins Pipeline](docs/poze_readme/jenkins_pipeline.png)
...
Momentan această secțiune va fi completată după ce ofer review unui coleg.
